        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 md:grid-cols-2 lg:grid-cols-4 lg:px-8">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed text-gray-500">
              همه‌چیز از بهمن ۱۴۰۳ شروع شد؛ با عشق، ذوق و یه عالمه ترس .شروع کردم و قدم‌به‌قدم یاد گرفتم، تجربه کردم و بزرگ‌ترش کردم.
شاید مسیر همیشه آسون نبود، ولی هر سفارشی که ثبت شد و هر اعتمادی که بهم کردید، باعث شد ادامه بدم🧚🏼‍♀️️
ممنونم که کنارمونید و بخشی از این مسیر قشنگ هستید🫂🤍
            </p>
          </div>
