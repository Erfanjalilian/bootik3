...
const STATIC_LOGO_URL = "/logo/file_00000000267c8210a963b2de2a0da3f0-no-bg.png";
      ...
      <div className="glass border-b border-pink-200/50">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 lg:px-8">
          <Link href="/" className="group flex items-center gap-2">
            <img src={STATIC_LOGO_URL} alt="لوگو" className="h-[120px] w-[120px] rounded-2xl object-contain" />
            <div>
